...
1. Ensure GitHub Pages is enabled with source set to “Deploy from a branch” and the `/` folder on `main`.
2. Push to `main`; the included workflow (`.github/workflows/pages.yml`) uploads the repository root and publishes it to the GitHub Pages environment.
